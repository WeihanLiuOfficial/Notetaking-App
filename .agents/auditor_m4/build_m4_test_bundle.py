...
out_file = r"e:\Projects\Notetaking App\.agents\auditor_m4\run_all_tests.mjs"
with open(out_file, "w", encoding="utf-8") as f:
    f.write(bundle_code)

node_exe = r"C:\Program Files\Adobe\Adobe Creative Cloud Experience\libs\node.exe"
result = subprocess.run([node_exe, out_file], capture_output=True, text=True)
print("=== STDOUT ===")
print(result.stdout)
print("=== STDERR ===")
print(result.stderr)
